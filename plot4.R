...
plot(dataset$DateTime,as.numeric(dataset$Voltage),type="l",xlab="datetime",ylab="Voltage")
...
plot(dataset$DateTime,as.numeric(dataset$Global_reactive_power),type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()